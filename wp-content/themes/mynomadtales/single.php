...
<section class="section-page">
    ...
    <? if(!empty($blog_page_banner)) { ?>
    	<div class="page-banner desktop fixed show-600" style="background-image:url(<?=$blog_page_banner['url']?>)"></div>
        <div class="page-banner mobile fixed hide-600" style="background-image:url(<?=$blog_page_banner['sizes']['medium_large']?>)"></div>
        <? /*
